...
public class BatterySubsystemPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Battery Subsystem");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BatterySubsystemPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BatterySubsystemPage().setVisible(true);
            }
        });
    }
    ...
    public BatterySubsystemPage(String x, BatterySystem bat, int[] StateList, String email) {
        ...
        else if (this.StateList[1] == 2 && this.StateList[2] == 2)   
            this.jPanel7.setBackground(Color.yellow);
            this.jLabel22.setText("System Charging");
        }
    }
